...
canchas_disponibles = []       # Lista de canchas con tipo y disponibilidad
reservas_realizadas = []       # Lista de reservas realizadas
jugadores_registrados = []     # Lista de jugadores registrados
